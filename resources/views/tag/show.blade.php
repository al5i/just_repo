...
<body>
<form action="{{ route('tag.create') }}" method="POST" style="margin-left: 10px; margin-top: 10px;">
    @csrf
    <div class="form-group">
        <label for="exampleInputEmail1">Добавить Теги</label>
        ...
        <div class="card-body p-0">
            <table class="table table-sm">
                ...
                <tr class="align-middle">
                    ...
                    <td>{{$tag->title}}</td>
                    <td>
                        <a class="" style="color: red;" href="{{ route('tag.show_category', $tag->id) }}">
